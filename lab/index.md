...
<!--
  AJOUTER UN OUTIL
  ────────────────
  1. Crée le dossier  lab/nom-de-loutil/  et mets ton fichier dedans sous le nom
     index.html. C'est du HTML brut : aucun gabarit, aucune contrainte, Jekyll le
     recopie tel quel. L'URL sera  alexisainouz.com/lab/nom-de-loutil/
  2. Remplace la ligne "The first ones land here shortly" par, pour chaque outil :
